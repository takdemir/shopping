...
final class Version20210918144811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("
            INSERT INTO `shopping`.`discount` (`id`, `user_id`, `category_id`, `product_id`, `discount_code`, `discount_class_name`, `parameters`, `is_active`, `created_at`, `start_at`, `expire_at`) VALUES (1, NULL, NULL, NULL, 'N_PERCENT_OVER_K', 'PercentOverDiscount', '{\"discountPercent\": \"10\", \"basketTotalForDiscount\": \"1000\"}', 1, '2021-09-18 16:36:19', '2021-09-18 16:36:19', '2021-10-30 16:36:19');
            INSERT INTO `shopping`.`discount` (`id`, `user_id`, `category_id`, `product_id`, `discount_code`, `discount_class_name`, `parameters`, `is_active`, `created_at`, `start_at`, `expire_at`) VALUES (2, NULL, 2, NULL, 'BUY_N_GET_K', 'BuyNPayKDiscount', '{\"buy\": \"6\", \"pay\": \"5\", \"free\": \"1\", \"products\": \"[]\", \"categories\": \"[2]\"}', 1, '2021-09-18 16:38:05', '2021-09-18 16:36:19', '2021-10-30 16:36:19');
            INSERT INTO `shopping`.`discount` (`id`, `user_id`, `category_id`, `product_id`, `discount_code`, `discount_class_name`, `parameters`, `is_active`, `created_at`, `start_at`, `expire_at`) VALUES (3, NULL, 1, NULL, 'BUY_N_DECREASE_PERCENT', 'BuyNDecreasePercentDiscount', '{\"buy\": \"2\", \"products\": \"[]\", \"categories\": \"[1]\", \"discountPercent\": \"20\"}', 1, '2021-09-18 16:39:09', '2021-09-18 16:36:19', '2021-10-30 16:36:19');
        ...
        $this->addSql("
            INSERT INTO `shopping_test`.`discount` (`id`, `user_id`, `category_id`, `product_id`, `discount_code`, `discount_class_name`, `parameters`, `is_active`, `created_at`, `start_at`, `expire_at`) VALUES (1, NULL, NULL, NULL, 'N_PERCENT_OVER_K', 'PercentOverDiscount', '{\"discountPercent\": \"10\", \"basketTotalForDiscount\": \"1000\"}', 1, '2021-09-18 16:36:19', '2021-09-18 16:36:19', '2021-10-30 16:36:19');
            INSERT INTO `shopping_test`.`discount` (`id`, `user_id`, `category_id`, `product_id`, `discount_code`, `discount_class_name`, `parameters`, `is_active`, `created_at`, `start_at`, `expire_at`) VALUES (2, NULL, 2, NULL, 'BUY_N_GET_K', 'BuyNPayKDiscount', '{\"buy\": \"6\", \"pay\": \"5\", \"free\": \"1\", \"products\": \"[]\", \"categories\": \"[2]\"}', 1, '2021-09-18 16:38:05', '2021-09-18 16:36:19', '2021-10-30 16:36:19');
            INSERT INTO `shopping_test`.`discount` (`id`, `user_id`, `category_id`, `product_id`, `discount_code`, `discount_class_name`, `parameters`, `is_active`, `created_at`, `start_at`, `expire_at`) VALUES (3, NULL, 1, NULL, 'BUY_N_DECREASE_PERCENT', 'BuyNDecreasePercentDiscount', '{\"buy\": \"2\", \"products\": \"[]\", \"categories\": \"[1]\", \"discountPercent\": \"20\"}', 1, '2021-09-18 16:39:09', '2021-09-18 16:36:19', '2021-10-30 16:36:19');
        ");
    }
