...
final class Version20210917142707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO `shopping`.`category` (`id`, `name`, `is_active`, `created_at`) VALUES (NULL, "Tornavida", 1, "2021-09-17 14:53:50")');
        $this->addSql('INSERT INTO `shopping`.`category` (`id`, `name`, `is_active`, `created_at`) VALUES (NULL, "Anahtar Seti", 1, "2021-09-17 14:54:11")');
    }
